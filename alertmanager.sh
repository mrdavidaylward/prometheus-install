...
wget https://github.com/prometheus/alertmanager/releases/download/v${VERSION}/alertmanager-${VERSION}.linux-armv7.tar.gz
tar xvzf alertmanager-${VERSION}.linux-armv7.tar.gz

sudo cp alertmanager-${VERSION}.linux-armv7/alertmanager /usr/local/bin/
sudo cp alertmanager-${VERSION}.linux-armv7/amtool /usr/local/bin/
...
rm alertmanager-${VERSION}.linux-armv7.tar.gz
rm -rf alertmanager-${VERSION}.linux-armv7
