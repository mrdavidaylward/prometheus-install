...
wget https://github.com/prometheus/prometheus/releases/download/v${VERSION}/prometheus-${VERSION}.linux-armv7.tar.gz
tar xvzf prometheus-${VERSION}.linux-armv7.tar.gz

sudo cp prometheus-${VERSION}.linux-armv7/prometheus /usr/local/bin/
sudo cp prometheus-${VERSION}.linux-armv7/promtool /usr/local/bin/
sudo cp -r prometheus-${VERSION}.linux-armv7/consoles /etc/prometheus
sudo cp -r prometheus-${VERSION}.linux-armv7/console_libraries /etc/prometheus
...
rm prometheus-${VERSION}.linux-armv7.tar.gz
rm -rf prometheus-${VERSION}.linux-armv7
