...
wget https://github.com/prometheus/node_exporter/releases/download/v${VERSION}/node_exporter-${VERSION}.linux-armhf.tar.gz
tar xvzf node_exporter-${VERSION}.linux-armhf.tar.gz

sudo cp node_exporter-${VERSION}.linux-armhf/node_exporter /usr/local/bin/
...
rm node_exporter-${VERSION}.linux-armhf.tar.gz
rm -rf node_exporter-${VERSION}.linux-armhf
