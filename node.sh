...
wget https://github.com/prometheus/node_exporter/releases/download/v${VERSION}/node_exporter-${VERSION}.linux-armv7.tar.gz
...
rm node_exporter-${VERSION}.linux-armv7.tar.gz
rm -rf node_exporter-${VERSION}.linux-armv7
